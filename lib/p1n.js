...
$(function() {
	...
	if ($('div#cipherdata').text().length > 1) {
		...
		if (window.location.hash.length == 0) {
			showError('Cannot decrypt url: Decryption key missing in URL (Did you use a redirector or an URL shortener which strips part of the URL ?)');
			return;
		}
...
this.enterKeyboardCmd = function(data, event) {
	ko.computed(function() {
		if (data.rawUrlString() != undefined) {
			...
			if ((str.substring(0, 1) != "h") && (str.substring(1, 2) != "t")
					&& (str.substring(2, 3) != "t")) {
